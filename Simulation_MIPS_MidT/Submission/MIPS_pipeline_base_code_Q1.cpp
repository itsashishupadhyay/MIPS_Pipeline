...
int main()
{
    ...
    float branch_taken =0.0;
    float branch_not_taken =0.00;
    float total_branch = 0.0;
    ...
    total_branch=branch_not_taken + branch_taken;

    cout<<"Total Branch Instruction: "<<total_branch<<endl;
    cout<<"Total Taken Branch: "<< branch_taken<<endl;
    cout<<"Total Not Taken Branch: "<< branch_not_taken<<endl;
    
    branch_taken_rate = branch_taken/total_branch;
